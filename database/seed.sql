...
INSERT INTO booking (
    ...
    hotel_branch_id, user_id, booking_price
)
VALUES
-- Branch 1
('2026-05-05','2026-05-07',NOW(),1,1,500000),
('2026-05-08','2026-05-10',NOW(),1,2,600000),

-- Branch 2
('2026-05-06','2026-05-08',NOW(),2,3,550000),
('2026-05-09','2026-05-11',NOW(),2,1,700000),

-- Branch 3
('2026-05-05','2026-05-06',NOW(),3,2,400000),
('2026-05-07','2026-05-09',NOW(),3,3,650000),

-- Branch 4
('2026-05-06','2026-05-07',NOW(),4,1,450000),
('2026-05-08','2026-05-09',NOW(),4,2,600000),

-- Branch 5
('2026-05-05','2026-05-07',NOW(),5,3,500000),
('2026-05-08','2026-05-10',NOW(),5,1,700000),

-- Branch 6
('2026-05-06','2026-05-08',NOW(),6,2,550000),
('2026-05-09','2026-05-11',NOW(),6,3,750000),

-- Branch 7
('2026-05-05','2026-05-06',NOW(),7,1,400000),
('2026-05-07','2026-05-09',NOW(),7,2,650000),

-- Branch 8
('2026-05-06','2026-05-08',NOW(),8,3,500000),
('2026-05-09','2026-05-11',NOW(),8,1,700000),

-- Branch 9
('2026-05-05','2026-05-07',NOW(),9,2,550000),
('2026-05-08','2026-05-10',NOW(),9,3,750000),

-- Branch 10
('2026-05-06','2026-05-07',NOW(),10,1,400000),
('2026-05-08','2026-05-09',NOW(),10,2,600000),

-- Branch 11
('2026-05-05','2026-05-07',NOW(),11,3,500000),
('2026-05-08','2026-05-10',NOW(),11,1,700000),

-- Branch 12
('2026-05-06','2026-05-08',NOW(),12,2,550000),
('2026-05-09','2026-05-11',NOW(),12,3,750000);
